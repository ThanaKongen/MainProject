...
using static DanBase.Shared.CustomerModels.Command.PrivateCustomerCommandDto;

namespace Application.Command
{
    public class PrivateCustomerApplicationService : IApplicationService
    {
        private readonly ICustomerRepository CustomerRepository;
        private readonly IUnitOfWork UnitOfWork;

        public PrivateCustomerApplicationService(ICustomerRepository customerRepository,  IUnitOfWork unitOfWork)
        {
        ...
        private async Task HandleUpdate(int Id, Action<PrivateCustomer> action)
        {
